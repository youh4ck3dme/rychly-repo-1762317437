...
const LoginScreen: React.FC = () => {
    ...
    const toggleText = isLoginView ? t('login_switch_to_signup') : t('login_switch_to_login');

    return (
        <div className="fixed inset-0 flex items-center justify-center p-4 animate-fade-in-up">
            <div className="w-full max-w-md text-center">
                <h1 className="text-5xl md:text-6xl font-serif text-black dark:text-white mb-10" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.2)' }}>
                    {t('vto_title')}
                </h1>
                ...
                <div className="glass-panel p-8">
                    <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                        ...
                        <FancyButton 
                            ...
                            disabled={isSubmitting || Object.keys(errors).length > 0 || !email || !password}
                        >
                            {isSubmitting ? (
