  ...
  >
    ...
    <div className="p-4">
      <motion.h3
        ...
        className="font-bold text-md leading-tight"
      >
        {post.title}
      </motion.h3>
      <motion.p
        layoutId={`blog-date-${post.id}`}
...
const BlogDetail = React.memo(
  ({ post, onBack }: { post: BlogPost; onBack: () => void }) => {
...
const InstagramFeed = React.memo(() => {
  ...
  return (
    <div className="bg-gray-900 p-4 rounded-lg mb-6">
      <h3 className="text-xl font-bold text-center text-yellow-300 mb-4 tracking-wide">
        {t("blog.instagram.title")}
      </h3>
