  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-grow">
        <h3 className="font-bold text-md leading-tight text-white">
          {trend.name}
        </h3>
        <p className="text-sm text-gray-400 mt-2 text-balance flex-grow">
          {trend.description}
        </p>
      </div>
    </motion.div>
    ...
    <div className="flex flex-col flex-grow bg-black text-white">
      <main className="flex-grow flex flex-col p-4">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-400 mt-1 text-balance">
            {t("explore.subtitle")}
          </p>
        </div>
        ...
        <AnimatePresence>
          {activeTab === "style" && (
            ...
            >
              ...
              <FilterButton
                filterType="Female"
                label={t("explore.filter.female")}
              />
              <FilterButton
                filterType="Male"
                label={t("explore.filter.male")}
              />
            </motion.div>
          )}
        </AnimatePresence>
