      ...
      <div className="relative aspect-square">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent p-2 sm:p-3 flex flex-col justify-end">
          ...
          <div className="flex items-center gap-2">
            <h3
              className="font-display text-white text-base sm:text-lg font-bold flex-grow"
      ...
      if (files && files.length > 0) {
        ...
        if (file.type.startsWith("image/")) {
          ...
          addNotification({
            type: "error",
            title: t("vto_error_title"),
            message: t("vto_error_invalidFileType"),
          });
        }
      }
    },
      ...
      <div className="text-center w-full max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
            {t("vto_dragDropZone_subtitle")}
          </p>
          {/* Horizontal line with "OR" text */}
          <div className="relative w-full text-center my-4">
            <span className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-black px-4 text-gray-500 dark:text-gray-400 text-sm z-10">
              {t("vto_or")}
            </span>
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          {!userImage && !isCameraOn && !isLoading && (
            <p className="text-lg text-gray-600 dark:text-gray-400 mt-6 max-w-2xl mx-auto">
              {t("vto_subtitle")}
            </p>
          )}
