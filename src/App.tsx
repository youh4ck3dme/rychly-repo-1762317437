...
const AppContent = React.memo((): React.ReactElement => {
  ...
  const [consultationStyle, setConsultationStyle] =
    useState<ConsultationStyle>("classic");
  const [hairstylePreference, setHairstylePreference] =
    useState<HairstylePreference>("keep");
        ...
        return (
          <div className="flex flex-col items-center justify-center w-full h-full">
            <h2 className="mb-2 text-2xl font-bold text-yellow-600">
              Štúdio | PAPI HAIR DESIGN & BARBER
            </h2>
            <p className="mb-4 text-lg text-gray-200">
              Vaša transformácia začína tu. Nasledujte kroky a vytvorte si
              vzhľad, ktorý je jedinečne váš.
            </p>
            ...
            <div className="relative w-full max-w-lg mb-8 overflow-hidden border rounded-lg bg-gradient-to-br from-purple-900/20 to-emerald-900/20 backdrop-blur-sm border-white/10">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <p className="px-4 text-lg text-center text-white/80">
                  ✨ Transformácia vlasov s AI ✨
                </p>
              </div>
            </div>
      ...
      case "upload":
        return (
          <ImageUploadScreen
            ...
            onHairstyleChange={setHairstylePreference}
          />
        );
      case "analysis":
        if (!userImage) {
...
const App = (): React.ReactElement => <AppContent />;
