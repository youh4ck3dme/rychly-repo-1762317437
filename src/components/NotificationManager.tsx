  ...
  const sendTestNotification = async () => {
    ...
    try {
      ...
      const testNotification: NotificationData = {
        ...
        message:
          "Váš termín na zajtra o 14:00 bol úspešne potvrdený. Tešíme sa na vás v PAPI Hair Design!",
        type: "booking",
          ...
          <div className="mb-8 p-4 rounded-xl border-2 bg-gray-800/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div
                  className={`w-4 h-4 rounded-full ${permission === "granted" ? "bg-green-400" : permission === "denied" ? "bg-red-400" : "bg-yellow-400"}`}
                ></div>
                <div>
              ...
              <div className="text-center py-12 text-gray-400">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth="2"
                    d="M15 17h5l-5 5-5-5h5V12h-5l5-5 5 5h-5v5zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"
                  ></path>
                </svg>
