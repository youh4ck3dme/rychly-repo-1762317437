      ...
      >
        <defs>
          ...
          <linearGradient id="hologramGlow" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <stop offset="25%" style={{ stopColor: '#FFA500', stopOpacity: 0.8 }} />
            <stop offset="50%" style={{ stopColor: '#FF6B35', stopOpacity: 0.9 }} />
            <stop offset="75%" style={{ stopColor: '#F7931E', stopOpacity: 0.8 }} />
        ...
        <g transform="translate(20, 20)">
          {/* Chat bublina tělo */}
          <ellipse cx="12" cy="18" rx="18" ry="12"
                   fill="url(#hologramGlow)"
                   filter="url(#innerGlow)"
                   opacity="0.8"/>

          {/* Chat bublina špička */}
          <polygon points="8,26 12,30 16,26"
                   fill="url(#hologramGlow)"
                   opacity="0.8"/>

          {/* Chat bublina vnitřní stín */}
          <ellipse cx="12" cy="18" rx="16" ry="10"
                   fill="none"
        ...
        <g transform="translate(42, 18)" opacity="0.9">
          {/* Horní čepel nůžek */}
          <path d="M2,8 L8,2 L9,3 L3,9 Z"
                fill="url(#hologramGlow)"
                filter="url(#shadow3d)"/>

          {/* Spodní čepel nůžek */}
          <path d="M2,10 L8,16 L7,17 L1,11 Z"
                fill="url(#hologramGlow)"
                filter="url(#shadow3d)"/>
