...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'welcome.subtitle': 'Get an expert hair diagnosis and discover your perfect, tailor-made color with advanced AI.',
    ...
    'upload.subtitle': 'Your transformation begins here. Follow the steps to craft a look that is uniquely yours.',
    'upload.nextStep': 'Next Step',
    'upload.prevStep': 'Previous Step',
    
    'upload.consultationStyleTitle': 'Choose Your Style Rune',
    'upload.consultationStyleSubtitle': 'Select the essence of the look you wish to achieve.',
    ...
    'upload.styles.bohemian.desc': 'Free-spirited, earthy, with a touch of romance.',
    ...
    'upload.styles.futuristic.desc': 'Sleek, avant-garde, and ahead of its time.',
    
    'upload.hairstylePreferenceTitle': 'Envision Your Form',
    'upload.hairstylePreferenceSubtitle': 'Choose a foundational cut for your new style.',
    ...
    'upload.hairstyles.longLayers.desc': 'Flowing movement and graceful volume.',
    ...
    'upload.hairstyles.wavyLob.desc': 'Effortlessly cool with soft, textured waves.',
    'upload.hairstyles.shaggyBob': 'Shaggy Bob',
    'upload.hairstyles.shaggyBob.desc': 'A textured bob with choppy layers for a rebellious, chic look.',
    'upload.hairstyles.butterflyCut': 'Butterfly Cut',
    'upload.hairstyles.butterflyCut.desc': 'Feathery, face-framing layers with longer lengths for dramatic volume.',
    'upload.hairstyles.wolfCut': 'Wolf Cut',
    'upload.hairstyles.wolfCut.desc': 'A wild mix of a shag and a mullet, full of texture and attitude.',
    'upload.hairstyles.italianBob': 'Italian Bob',
    'upload.hairstyles.italianBob.desc': 'A chunky, neck-grazing bob with a heavy, luxurious weight line.',
    'upload.hairstyles.bixieCut': 'Bixie Cut',
    'upload.hairstyles.bixieCut.desc': 'The perfect hybrid of a bob and pixie for versatile, short styling.',
    'upload.hairstyles.octopusCut': 'Octopus Cut',
    'upload.hairstyles.octopusCut.desc': 'Volume on top with wispy, tentacle-like layers below.',
    'upload.hairstyles.curveCut': 'Curve Cut (C-Cut)',
    'upload.hairstyles.curveCut.desc': 'Soft, C-shaped layers that curve inwards, beautifully framing the face.',
    'upload.hairstyles.modernMullet': 'Modern Mullet',
    'upload.hairstyles.modernMullet.desc': 'A softer, more refined take on the classic "business in front, party in back".',
    'upload.hairstyles.birkinBangs': 'Birkin Bangs',
    'upload.hairstyles.birkinBangs.desc': 'Wispy, eyebrow-grazing fringe inspired by Jane Birkin\'s iconic look.',
    'upload.hairstyles.hushCut': 'Hush Cut',
    'upload.hairstyles.hushCut.desc': 'A soft, heavily-layered Korean cut with gentle, face-framing pieces.',

    'upload.finalStepTitle': 'Summon Your Image',
    'upload.finalStepSubtitle': 'Provide a clear, well-lit selfie for the ritual.',
    'upload.useCamera': 'Use Camera',
    'upload.uploadPhoto': 'Upload a Photo',
    'upload.cameraError.notSupported': 'Camera not supported on this device or browser.',
    'upload.cameraError.denied': 'Camera access was denied. Please allow camera access in your browser settings.',
    'upload.cameraError.notFound': 'No camera found on this device.',
    'upload.cameraError.generic': 'Could not access the camera. Please try again.',
    'upload.cameraError.notReady': 'Camera is not ready yet. Please wait a moment.',
    ...
    'services.note': 'Note: Prices include VAT and may vary depending on the selected stylist or team member.',
    ...
    'blog.empty.text': 'New articles and insights from our stylists are being prepared. Check back later for fresh content!',
    // About Us
    'about.title': 'About Us',
    'about.intro': 'Welcome to our sanctuary of style. We are a team of passionate artists dedicated to the craft of hairdressing, where creativity and expertise combine to create unforgettable looks.',
    'about.book': 'Book an Appointment',
    'about.viewServices': 'View Pricelist',
    'about.philosophy.title': 'Our Philosophy',
    'about.philosophy.text': 'At Papi Hair Design, we believe that a great hairstyle is a work of art. It is an expression of your individuality and a reflection of your personal style. Our mission is to provide a personalized, luxurious experience for every client. We use only the highest quality products and keep up with the latest trends and techniques to bring you the best in hair care and design.',
    'about.stats.clients': '500+ satisfied clients',
    'about.stats.experience': '15+ years of experience',
    'about.team.title': 'Our Talented Team',
    'about.team.intro': 'The heart and soul of our salon. Meet the artists behind the chairs.',
    'about.team.papi.name': 'Papi',
    'about.team.papi.title': 'Owner & Master Stylist',
    'about.team.papi.bio': 'The founder of the salon with more than 15 years of experience in hair design. Specializes in premium services and creative transformations.',
    ...
    'about.team.mato.bio': 'A specialist in men\'s cuts and beard grooming with a modern approach. Master of classic and modern cutting techniques.',
    ...
    'about.team.miska.bio': 'Creativity and modern techniques are her strong suit. An expert in color transformations and the latest trends in hairdressing.',
    ...
    'about.cta.text': 'Book your appointment today and let our experts take care of your new look.',
    'about.cta.bookOnline': 'Book Online',
    'about.cta.call': 'Call: +421 949 459 624',
    // Contact
    'contact.title': 'Contact Us',
    'contact.intro': 'A luxury hair salon in the center of Košice. Book an appointment or visit us for professional services at the highest level.',
    ...
    'contact.booking.text': 'Book your appointment online or contact us by phone. Our team will be happy to help you choose the right service.',
    ...
    'contact.form.message.placeholder': 'Describe your requirements or questions...',
    'contact.form.submit': 'Send Message',
    'contact.form.submitted.title': 'Message Sent!',
    'contact.form.submitted.message': 'Thank you for contacting us. We will get back to you shortly.',
    ...
    'chatbot.initialMessage': 'Hello! I am your PAPI HAIR DESIGN & BARBER AI Stylist. How can I help you today?',
    ...
    'errorBoundary.message': 'An unexpected error occurred. Try restarting the app.',
  ...
  sk: {
    ...
    'welcome.subtitle': 'Získajte odbornú diagnózu vlasov a objavte svoju dokonalú, na mieru šitú farbu s pokročilou AI.',
    ...
    'upload.subtitle': 'Vaša transformácia začína tu. Nasledujte kroky a vytvorte si vzhľad, ktorý je jedinečne váš.',
    'upload.nextStep': 'Ďalší krok',
    'upload.prevStep': 'Späť',

    'upload.consultationStyleTitle': 'Vyberte si runu štýlu',
    'upload.consultationStyleSubtitle': 'Zvoľte esenciu vzhľadu, ktorý chcete dosiahnuť.',
    ...
    'upload.styles.lowMaintenance.desc': 'Prirodzená ladnosť s minimálnou údržbou.',
    ...
    'upload.styles.bohemian.desc': 'Slobodomyseľný, zemitý, s dotykom romantiky.',
    'upload.styles.artDeco': 'Art Deco',
    'upload.styles.artDeco.desc': 'Geometrická precíznosť sa stretáva s opulentným pôvabom.',
    'upload.styles.futuristic': 'Futuristický',
    'upload.styles.futuristic.desc': 'Elegantný, avantgardný a predbehajúci svoju dobu.',

    'upload.hairstylePreferenceTitle': 'Predstavte si svoju formu',
    'upload.hairstylePreferenceSubtitle': 'Zvoľte základný strih pre váš nový štýl.',
    ...
    'upload.hairstyles.wavyLob.desc': 'Nenápadne cool s jemnými, textúrovanými vlnami.',
    'upload.hairstyles.shaggyBob': 'Shaggy Bob',
    'upload.hairstyles.shaggyBob.desc': 'Textúrovaný bob s rozstrapkanými vrstvami pre rebelantský, šik vzhľad.',
    'upload.hairstyles.butterflyCut': 'Motýlí Strih',
    'upload.hairstyles.butterflyCut.desc': 'Vzdušné vrstvy rámujúce tvár s dlhšími koncami pre dramatický objem.',
    'upload.hairstyles.wolfCut': 'Wolf Cut',
    'upload.hairstyles.wolfCut.desc': 'Divoký mix shag a mullet účesu, plný textúry a sebavedomia.',
    'upload.hairstyles.italianBob': 'Taliansky Bob',
    'upload.hairstyles.italianBob.desc': 'Robustný bob s dĺžkou po krk s ťažkou, luxusnou líniou.',
    'upload.hairstyles.bixieCut': 'Bixie Strih',
    'upload.hairstyles.bixieCut.desc': 'Perfektný hybrid medzi bobom a pixie pre všestranný, krátky styling.',
    'upload.hairstyles.octopusCut': 'Chobotnicový Strih',
    'upload.hairstyles.octopusCut.desc': 'Objem na vrchu s jemnými, chápadlovitými vrstvami naspodu.',
    'upload.hairstyles.curveCut': 'Oblúkový Strih (C-Cut)',
    'upload.hairstyles.curveCut.desc': 'Jemné vrstvy v tvare písmena C, ktoré sa stáčajú dovnútra a krásne rámujú tvár.',
    'upload.hairstyles.modernMullet': 'Moderný Mullet',
    'upload.hairstyles.modernMullet.desc': 'Jemnejšia a rafinovanejšia verzia klasiky "vpredu biznis, vzadu párty".',
    'upload.hairstyles.birkinBangs': 'Birkin Ofina',
    'upload.hairstyles.birkinBangs.desc': 'Jemná ofina siahajúca po obočie, inšpirovaná ikonickým vzhľadom Jane Birkin.',
    'upload.hairstyles.hushCut': 'Hush Strih',
    'upload.hairstyles.hushCut.desc': 'Jemný, silne vrstvený kórejský strih s nežnými kúskami rámujúcimi tvár.',
    
    'upload.finalStepTitle': 'Vyvolajte svoj obraz',
    'upload.finalStepSubtitle': 'Pre rituál poskytnite jasnú, dobre osvetlenú selfie.',
    'upload.useCamera': 'Použiť fotoaparát',
    'upload.uploadPhoto': 'Nahrať fotku',
    'upload.cameraError.notSupported': 'Fotoaparát nie je na tomto zariadení alebo v prehliadači podporovaný.',
    'upload.cameraError.denied': 'Prístup k fotoaparátu bol zamietnutý. Povoľte prístup v nastaveniach prehliadača.',
    'upload.cameraError.notFound': 'Na tomto zariadení sa nenašiel žiadny fotoaparát.',
    'upload.cameraError.generic': 'Nepodarilo sa získať prístup k fotoaparátu. Skúste to prosím znova.',
    'upload.cameraError.notReady': 'Fotoaparát ešte nie je pripravený. Počkajte chvíľu.',
    ...
    // Explore
    'explore.subtitle': 'Objavte najnovšie trendy oživené umelou inteligenciou.',
    ...
    'services.note': 'Pozn.: Ceny sú uvedené s DPH a môžu sa líšiť v závislosti od vybraného kaderníka alebo člena tímu.',
    ...
    'blog.empty.text': 'Pripravujeme nové články a postrehy od našich stylistov. Vráťte sa neskôr pre čerstvý obsah!',
    // About Us
    'about.title': 'O nás',
    'about.intro': 'Vitajte v našom sanktváriu štýlu. Sme tím vášnivých umelcov, ktorí sa venujú remeslu kaderníctva, kde sa kreativita a odbornosť spájajú a vytvárajú nezabudnuteľné looky.',
    'about.book': 'Rezervovať termín',
    'about.viewServices': 'Pozrieť cenník',
    'about.philosophy.title': 'Naša filozofia',
    'about.philosophy.text': 'V Papi Hair Design veríme, že skvelý účes je umeleckým dielom. Je to vyjadrenie vašej individuality a odraz vašeho osobného štýlu. Našou misiou je poskytnúť personalizovaný, luxusný zážitok pre každého klienta. Používame len najkvalitnejšie produkty a držíme krok s najnovšími trendmi a technikami, aby sme vám priniesli to najšie v starostlivosti o vlasy a dizajne.',
    ...
    'about.team.intro': 'Srdce a duša nášho salónu. Spoznajte umelcov za kreslami.',
    'about.team.papi.name': 'Papi',
    'about.team.papi.title': 'Majiteľ & Master Stylist',
    'about.team.papi.bio': 'Zakladateľ salónu s viac ako 15 rokmi skúseností v oblasti vlasového dizajnu. Špecializuje sa na prémiové služby a kreativné transformácie.',
    ...
    'about.team.mato.name': 'Maťo',
    'about.team.mato.title': 'Professional Barber',
    'about.team.mato.bio': 'Špecialista na pánske strihy a úpravu brady s moderným prístupom. Majster klasických aj moderných techník strihánia.',
    ...
    'about.team.miska.name': 'Miška',
    'about.team.miska.title': 'Creative Hair Artist',
    'about.team.miska.bio': 'Kreativita a moderné techniky sú jej silnou stránkou. Expertka na farebné transformácie a najnovšie trendy v kaderníctve.',
    ...
    'about.cta.text': 'Rezervujte si termín ešte dnes a nechajte našich expertov postarať sa o váš nový look.',
    'about.cta.bookOnline': 'Rezervovať online',
    'about.cta.call': 'Zavolať: +421 949 459 624',
    // Contact
    'contact.title': 'Kontaktujte nás',
    'contact.intro': 'Luxusný kadernícky salón v centre Košíc. Rezervujte si termín alebo nás navštívte pre profesionálne služby na najvyššej úrovni.',
    ...
    'contact.booking.text': 'Rezervujte si termín online alebo nás kontaktujte telefonicky. Náš tím vám rád pomôže vybrať správnu službu.',
    ...
    'contact.form.message.placeholder': 'Opíšte vaše požiadavky alebo otázky...',
    'contact.form.submit': 'Odoslať správu',
    'contact.form.submitted.title': 'Správa odoslaná!',
    'contact.form.submitted.message': 'Ďakujeme, že ste nás kontaktovali. Ozveme sa vám čo najskôr.',
    ...
    'contact.social.text': 'Zostaňte v kontakte a sledujte naše najnovšie práce',
    // Footer
    'footer.home': 'Domov',
    ...
    'chatbot.initialMessage': 'Dobrý deň! Som váš PAPI HAIR DESIGN & BARBER AI Stylista. Ako vám dnes môžem pomôcť?',
    'chatbot.error': 'Ospravedlňujem sa, vyskytla sa chyba. Skúste to prosím znova.',
...
export const LanguageProvider = React.memo(({ children }: { children: React.ReactNode }): React.ReactElement => {
