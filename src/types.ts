...
export type HairstylePreference = 'keep' | 'bob' | 'longLayers' | 'pixie' | 'wavyLob' | 'shaggyBob' | 'butterflyCut' | 'wolfCut' | 'italianBob' | 'bixieCut' | 'octopusCut' | 'curveCut' | 'modernMullet' | 'birkinBangs' | 'hushCut';
